...
users = [
    ...
    {"name": "Diyor", "email": "diyor19@outlook.com", "age": 39, "phone": "+998923445566", "country": "France"},
      ...
      # default qiymatda izlab kurish uchunpasdagi kodni komentdan ochib input qilinganini kamentga olish kerak!
#phone = "+998977778899"
phone = input("Mobil raqamni kiriting: ")

user = find_user_by_phone(users, phone)
if user:
    print("Foydalanuvchi topildi:", user)
else:
